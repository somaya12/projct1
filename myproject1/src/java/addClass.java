...
public class addClass extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       ArrayList allvalid=ClassInfo.isValid(classNum, name, de);
       
       if(allvalid.isEmpty())
       {
           
       ClassInfo st=new ClassInfo(name,de,level,Teacher,classNum);
       st.addSTD();
       ...
       else
       {
           ...
           response.sendRedirect("http://localhost:8085/Myproject1/addClass.jsp");
       }
